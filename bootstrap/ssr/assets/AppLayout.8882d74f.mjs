...
import { J as JetBanner, a as JetDropdownSidebar, b as JetDropdownLinkSidebar, _ as _sfc_main$1, c as JetNavLinkSidebar } from "./NavLink.67838388.mjs";
import { FontAwesomeIcon } from "@fortawesome/vue-fontawesome";
import { library } from "@fortawesome/fontawesome-svg-core";
import { faBell, faArrowCircleUp, faArrowCircleDown, faExchangeAlt } from "@fortawesome/free-solid-svg-icons";
...
const _sfc_main = defineComponent({
  ...
  methods: {
    ...
    activeWithdrawals() {
      if (route().current("users.withdrawals") || route().current("withdrawal.show")) {
        return true;
      } else {
        return false;
      }
    ...
    activeDeposits() {
      if (route().current("users.deposits") || route().current("deposit.create") || route().current("deposit.show")) {
        return true;
      } else {
        return false;
      }
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
    ...
    content: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_jet_dropdown_link_sidebar, {
          ...
          active: _ctx.route().current("user.edit")
        }, {
        ...
        _push2(ssrRenderComponent(_component_jet_dropdown_link_sidebar, {
          ...
          active: _ctx.activeVerification()
        }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Verificar Cuenta `);
            } else {
              return [
                createTextVNode(" Verificar Cuenta ")
              ];
            }
          }),
          _: 1
        ...
        _push2(`<div class="bg-gradient-to-r from-dark-brand via-slate-300 to-dark-brand h-[1px] my-1"${_scopeId}></div><form${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_dropdown_link_sidebar, {
        ...
        return [
          ...
          createVNode("div", { class: "bg-gradient-to-r from-dark-brand via-slate-300 to-dark-brand h-[1px] my-1" }),
          createVNode("form", {
  ...
  _push(ssrRenderComponent(_component_jet_nav_link_sidebar, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<span${_scopeId}>Dep\xF3sitos a Broker</span>`);
      } else {
        return [
          createVNode(_component_font_awesome_icon, {
            class: "text-gray-300 ml-2 mr-4 h-8",
          ...
          createVNode("span", null, "Dep\xF3sitos a Broker")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_jet_nav_link_sidebar, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<span${_scopeId}>Retiros de Broker</span>`);
      } else {
        return [
          createVNode(_component_font_awesome_icon, {
            class: "text-gray-300 ml-2 mr-4 h-8",
          ...
          createVNode("span", null, "Retiros de Broker")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_jet_nav_link_sidebar, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<span${_scopeId}>Wallets Exchange</span>`);
      } else {
        return [
          createVNode(_component_font_awesome_icon, {
            class: "text-gray-300 ml-2 mr-4 h-8",
          ...
          createVNode("span", null, "Wallets Exchange")
        ];
      }
    }),
    _: 1
  ...
  _push(`<div class="ml-3 absolute top-7"><div class="flex h-5 w-5"><span class="rounded-full h-5 w-5 bg-yellow-brand bg-opacity-60 text-sm text-black flex items-center pt-0 pb-[3px] justify-center"> 0 </span></div></div></div></div></div></div></nav><main class="${ssrRenderClass([{ "hidden": _ctx.showingNavigationDropdown }, "md:block overflow-y-auto min-h-[90vh]"])}">`);
