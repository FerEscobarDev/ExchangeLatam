...
import { _ as _sfc_main$1 } from "./Modal.688f150f.mjs";
const _sfc_main = {
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div></div></div><div class="px-6 py-4 bg-gray-100 text-right flex justify-end items-center rounded-lg"${_scopeId}>`);
            ssrRenderSlot(_ctx.$slots, "footer", {}, null, _push2, _parent2, _scopeId);
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 rounded-lg" }, [
              ...
              createVNode("div", { class: "px-6 py-4 bg-gray-100 text-right flex justify-end items-center rounded-lg" }, [
