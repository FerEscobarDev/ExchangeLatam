...
import PermissionCreateForm from "./PermissionCreateForm.7f847c14.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_PermissionCreateForm = resolveComponent("PermissionCreateForm");
  _push(ssrRenderComponent(_component_app_layout_admin, mergeProps({ title: "Crear Permiso" }, _attrs), {
      ...
      if (_push2) {
        ...
        return [
          createVNode("h2", { class: "font-semibold text-xl text-gray-700 leading-tight" }, [
            ...
            createTextVNode("Crear Nuevo Permiso ")
          ])
        ];
      }
    }),
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_PermissionCreateForm, null, null, _parent2, _scopeId));
            ...
            createVNode("div", { class: "flex mx-auto lg:mr-4" }, [
              createVNode("div", { class: "container mx-auto sm:px-6 lg:px-8" }, [
                createVNode("div", { class: "bg-white shadow-xl sm:rounded-lg p-8 overflow-visible" }, [
                  createVNode(_component_PermissionCreateForm)
                ])
              ])
            ])
          ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Permissions/Create.vue");
