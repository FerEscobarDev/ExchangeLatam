import { defineComponent, resolveComponent, mergeProps, withCtx, createTextVNode, createVNode, withModifiers, openBlock, createBlock, toDisplayString, useSSRContext } from "vue";
...
import CalculateBuyBalance from "./CalculateBuyBalance.2006aa9d.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_CalculateBuyBalance = resolveComponent("CalculateBuyBalance");
  _push(ssrRenderComponent(_component_app_layout, mergeProps({ title: "Comprar Saldo" }, _attrs), {
    header: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`Solicitud Compra Saldo De Skrill </h2>`);
      } else {
        return [
          createVNode("h2", { class: "font-semibold text-xl text-gray-700 leading-tight" }, [
            ...
            createTextVNode("Solicitud Compra Saldo De Skrill ")
          ])
        ];
      }
    }),
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="px-3 pt-5 md:pt-6 mb-4 lg:mr-4 max-w-full flex flex-col shadow border border-gray-200 sm:rounded-lg bg-white"${_scopeId}>`);
        ...
        if (!_ctx.issetWallet) {
          ...
          _push2(`<div class="col-span-12 flex justify-center items-center p-4"${_scopeId}><div class="rounded-lg bg-slate-200 text-dark-brand p-4 w-80 flex flex-col items-start mx-auto"${_scopeId}><span class="font-semibold"${_scopeId}>Cuenta Skrill</span><span class="flex"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>La compra de saldo ser\xE1 transferida a tu cuenta de Skrill relacionada a continuaci\xF3n:</span></span><span class="flex mt-2"${_scopeId}><span class="text-md text-gray-600 mr-1"${_scopeId}>Email: </span><span class="text-md font-semibold text-dark-brand"${_scopeId}>${ssrInterpolate(_ctx.walletAccount[0].email)}</span></span><span class="flex"${_scopeId}><span class="text-md text-gray-600 mr-1"${_scopeId}>Celular: </span><span class="text-md font-semibold text-dark-brand"${_scopeId}>${ssrInterpolate(_ctx.walletAccount[0].mobil)}</span></span></div></div>`);
        }
        _push2(`<div class="col-span-12 md:col-start-2 md:col-span-10 p-4"${_scopeId}><form${_scopeId}><div class="grid grid-cols-6 gap-1"${_scopeId}><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        ...
        _push2(ssrRenderComponent(_component_jet_select, {
          ...
          title: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Medio de pago: `);
            } else {
              return [
                createTextVNode(" Medio de pago: ")
              ];
            }
          }),
          _: 1
        ...
        _push2(ssrRenderComponent(_component_jet_input_error, {
          message: _ctx.form.errors.account,
          class: "mt-2"
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6"${_scopeId}>`);
        if (_ctx.issetWallet) {
          _push2(ssrRenderComponent(_component_CalculateBuyBalance, {
            amountUsd: _ctx.form.amount_usd,
            amountCop: _ctx.amount_cop,
            dollarPrice: _ctx.exchangeRate,
          ...
          createVNode("div", { class: "px-3 pt-5 md:pt-6 mb-4 lg:mr-4 max-w-full flex flex-col shadow border border-gray-200 sm:rounded-lg bg-white" }, [
            ...
            createVNode("div", { class: "grid grid-cols-12" }, [
              !_ctx.issetWallet ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "rounded-lg bg-slate-200 text-dark-brand p-4 w-80 flex flex-col items-start mx-auto" }, [
                  createVNode("span", { class: "font-semibold" }, "Cuenta Skrill"),
                  createVNode("span", { class: "flex" }, [
                    createVNode("span", { class: "text-sm text-gray-600 mr-1" }, "La compra de saldo ser\xE1 transferida a tu cuenta de Skrill relacionada a continuaci\xF3n:")
                  ]),
                  createVNode("span", { class: "flex mt-2" }, [
                    createVNode("span", { class: "text-md text-gray-600 mr-1" }, "Email: "),
                    createVNode("span", { class: "text-md font-semibold text-dark-brand" }, toDisplayString(_ctx.walletAccount[0].email), 1)
                  ]),
                  createVNode("span", { class: "flex" }, [
                    createVNode("span", { class: "text-md text-gray-600 mr-1" }, "Celular: "),
                    createVNode("span", { class: "text-md font-semibold text-dark-brand" }, toDisplayString(_ctx.walletAccount[0].mobil), 1)
                  ])
                ])
              ])),
                ...
                createVNode("form", {
                  ...
                  createVNode("div", { class: "grid grid-cols-6 gap-1" }, [
                    ...
                    createVNode("div", { class: "col-span-6" }, [
                      _ctx.issetWallet ? (openBlock(), createBlock(_component_CalculateBuyBalance, {
                        key: 0,
                        amountUsd: _ctx.form.amount_usd,
                        amountCop: _ctx.amount_cop,
                        dollarPrice: _ctx.exchangeRate,
                        walletVip: _ctx.walletAccount[0].vip,
                        user: _ctx.$page.props.user
                      }, null, 8, ["amountUsd", "amountCop", "dollarPrice", "walletVip", "user"])) : (openBlock(), createBlock(_component_CalculateBuyBalance, {
                        key: 1,
                        amountUsd: _ctx.form.amount_usd,
                        amountCop: _ctx.amount_cop,
                        dollarPrice: _ctx.exchangeRate,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/WalletExchange/CreateDepositWallet.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const CreateDepositWallet = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  CreateDepositWallet as default
};
