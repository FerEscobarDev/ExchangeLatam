...
import { _ as _sfc_main$3 } from "./AppLayout.83ff4bad.mjs";
...
const JetApplicationLogo = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender]]);
const _sfc_main$1 = {
  __name: "Welcome",
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(JetApplicationLogo, { class: "block h-12 w-auto" }, null, _parent));
