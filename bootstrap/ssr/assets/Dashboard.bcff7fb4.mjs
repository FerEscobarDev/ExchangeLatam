            ...
            createVNode("div", { class: "flex mx-auto lg:mr-4" }, [
              createVNode("div", { class: "container mx-auto sm:px-6 lg:px-8" }, [
                _ctx.$page.props.user.requirement_user.verified === 2 && _ctx.$page.props.user.accounts[0] && _ctx.transactions[0] ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("h1", { class: "text-3xl text-black/75 font-semibold p-5 text-center" }, "\xDAltimas Transacciones"),
