...
import RoleEditForm from "./RoleEditForm.1fa3937d.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_RoleEditForm = resolveComponent("RoleEditForm");
  _push(ssrRenderComponent(_component_app_layout_admin, mergeProps({ title: "Editar Precio" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_RoleEditForm, {
          role: _ctx.role,
          permissionsAll: _ctx.permissionsAll
            ...
            createVNode("div", { class: "flex mx-auto lg:mr-4" }, [
              createVNode("div", { class: "container mx-auto sm:px-6 lg:px-8" }, [
                createVNode("div", { class: "bg-white shadow-xl sm:rounded-lg p-8 overflow-visible" }, [
                  createVNode(_component_RoleEditForm, {
                    role: _ctx.role,
                    permissionsAll: _ctx.permissionsAll
                  }, null, 8, ["role", "permissionsAll"])
                ])
              ])
            ])
          ])
