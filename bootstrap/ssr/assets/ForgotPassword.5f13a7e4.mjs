...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_jet_authentication_card, null, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="mb-4 text-sm text-gray-600"${_scopeId}> \xBFOlvidaste tu contrase\xF1a? No hay problema. Simplemente puedes hacernos saber tu direcci\xF3n de correo electr\xF3nico y te enviaremos un enlace de restablecimiento de contrase\xF1a que te permitir\xE1 elegir una nueva. </div>`);
        if (_ctx.status) {
        ...
        _push2(ssrRenderComponent(_component_jet_button, {
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(` Recuperar contrase\xF1a `);
            } else {
              return [
        ...
        return [
          createVNode("div", { class: "mb-4 text-sm text-gray-600" }, " \xBFOlvidaste tu contrase\xF1a? No hay problema. Simplemente puedes hacernos saber tu direcci\xF3n de correo electr\xF3nico y te enviaremos un enlace de restablecimiento de contrase\xF1a que te permitir\xE1 elegir una nueva. "),
