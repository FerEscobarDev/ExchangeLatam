...
const _sfc_main = defineComponent({
  ...
  data() {
    return {
      pep: this.formKnowledgeClient.pep === 0 ? false : true,
      publicFunds: this.formKnowledgeClient.publicFunds === 0 ? false : true,
      tributeCountry: this.formKnowledgeClient.tributeCountry === 0 ? false : true,
      transactionsForeignMoney: this.formKnowledgeClient.transactionsForeignMoney === 0 ? false : true,
      productsFinancialExt: this.formKnowledgeClient.productsFinancialExt === 0 ? false : true,
      accountsForeignMoney: this.formKnowledgeClient.accountsForeignMoney === 0 ? false : true,
      auth_1: this.formKnowledgeClient.auth_1 === 0 ? false : true,
      auth_2: this.formKnowledgeClient.auth_2 === 0 ? false : true,
      sign: this.formKnowledgeClient.sign === 0 ? false : true
    };
  },
  methods: {
    monthFormat() {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_app_layout, mergeProps({ title: "Declaraci\xF3n de fondos" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="px-3 mb-4 pt-5 md:pt-6 lg:mr-4 max-w-full flex flex-col justify-center items-center shadow border border-gray-200 sm:rounded-lg bg-white"${_scopeId}><h1 class="text-3xl text-black/75 font-semibold px-3 pb-3 text-center"${_scopeId}>Formulario Conocimiento del Cliente</h1><div class="grid grid-cols-6 gap-2 px-4 py-5"${_scopeId}><div class="col-span-3 md:col-start-1 md:col-end-3"${_scopeId}>`);
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "text",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.formKnowledgeClient.citySign,
          "onUpdate:modelValue": ($event) => _ctx.formKnowledgeClient.citySign = $event
        }, null, _parent2, _scopeId));
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "number",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.data_user.doc_num,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.data_user.doc_num = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "expeditionDate",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "date",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.data_user.expeditionDate,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.data_user.expeditionDate = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "expeditionPlace",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "text",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.data_user.expeditionPlace,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.data_user.expeditionPlace = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "birthDate",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "date",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.data_user.birthDate,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.data_user.birthDate = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "birthPlace",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "text",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.data_user.birthPlace,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.data_user.birthPlace = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "nationality",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "text",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.data_user.nationality,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.data_user.nationality = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "mobil",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "number",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.mobil,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.mobil = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "email",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "number",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.financial_data_user.income,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.financial_data_user.income = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "expenses",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "number",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.financial_data_user.expenses,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.financial_data_user.expenses = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "assets",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "number",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.financial_data_user.assets,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.financial_data_user.assets = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "liabilities",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "number",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.financial_data_user.liabilities,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.financial_data_user.liabilities = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "heritage",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "number",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.financial_data_user.heritage,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.financial_data_user.heritage = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="col-span-6 md:col-span-2"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "incomeOther",
        ...
        _push2(ssrRenderComponent(_component_jet_input, {
          ...
          type: "number",
          class: "read-only:bg-gray-200 mt-1 block w-full",
          modelValue: _ctx.$page.props.user.financial_data_user.incomeOther,
          "onUpdate:modelValue": ($event) => _ctx.$page.props.user.financial_data_user.incomeOther = $event
        }, null, _parent2, _scopeId));
        _push2(`</div>`);
        if (_ctx.$page.props.user.financial_data_user.incomeOther) {
          _push2(`<div class="col-span-6"${_scopeId}>`);
          _push2(ssrRenderComponent(_component_jet_label, {
          ...
          _push2(ssrRenderComponent(_component_jet_input, {
            ...
            type: "text",
            class: "read-only:bg-gray-200 mt-1 block w-full",
            modelValue: _ctx.$page.props.user.financial_data_user.descriptionIncome,
            "onUpdate:modelValue": ($event) => _ctx.$page.props.user.financial_data_user.descriptionIncome = $event
          }, null, _parent2, _scopeId));
          _push2(`</div>`);
        } else {
          _push2(`<!---->`);
        ...
        return [
          createVNode("div", { class: "px-3 mb-4 pt-5 md:pt-6 lg:mr-4 max-w-full flex flex-col justify-center items-center shadow border border-gray-200 sm:rounded-lg bg-white" }, [
            ...
            createVNode("div", { class: "grid grid-cols-6 gap-2 px-4 py-5" }, [
              ...
              _ctx.$page.props.user.financial_data_user.incomeOther ? (openBlock(), createBlock("div", {
                key: 1,
                class: "col-span-6"
              }, [
                createVNode(_component_jet_label, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Profile/FormClientShow.vue");
