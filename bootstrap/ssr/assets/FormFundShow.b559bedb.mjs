...
const _sfc_main = defineComponent({
  ...
  data() {
    return {
      date: dayjs(this.dataUser[0].form_fund.date, "YYYY-MM-DD"),
      sign: this.dataUser[0].form_fund.sign === 0 ? false : true
    };
  },
  methods: {
    monthFormat() {
      ...
      if (_push2) {
        ...
        return [
          createVNode("h2", { class: "font-semibold text-xl text-gray-700 leading-tight" }, [
            ...
            createTextVNode(" Origen de Fondos ")
          ])
        ];
      }
    }),
                  ...
                  createVNode("div", null, [
                    createVNode("div", { class: "col-span-6" }, [
                      createVNode("p", { class: "text-lg md:text-xl text-black/60 font-medium text-justify px-4 md:px-8 max-w-3xl lg:mx-auto mb-4" }, [
                        createTextVNode(" Yo, "),
                        createVNode("span", { class: "text-black/50 font-semibold underline decoration-2" }, toDisplayString(_ctx.dataUser[0].name + " " + _ctx.dataUser[0].lastname), 1),
                        createTextVNode(", identificado(a) con el documento de identidad No. "),
                        createVNode("span", { class: "text-black/50 font-semibold underline decoration-2" }, toDisplayString(_ctx.dataUser[0].data_user.doc_num), 1),
                        createTextVNode(" expedido en "),
                        createVNode("span", { class: "text-black/50 font-semibold underline decoration-2" }, toDisplayString(_ctx.dataUser[0].data_user.expeditionPlace), 1),
                      ...
                      createVNode("p", { class: "text-lg md:text-xl text-black/60 font-medium text-justify px-4 md:px-8 max-w-3xl lg:mx-auto mb-4" }, [
                        ...
                        createVNode("span", { class: "text-black/50 font-semibold underline decoration-2" }, toDisplayString(_ctx.dataUser[0].form_fund.citySign), 1),
                        createTextVNode(". ")
                      ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Forms/FormFundShow.vue");
