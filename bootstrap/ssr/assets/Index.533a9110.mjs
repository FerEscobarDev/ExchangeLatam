...
const _sfc_main = defineComponent({
  ...
  methods: {
    ...
    info() {
      return console.log(this.withdrawals);
    }
  }
});
  ...
  _push(ssrRenderComponent(_component_app_layout, mergeProps({ title: "Retiros" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`</table>`);
        if (_ctx.withdrawals.data[0]) {
          _push2(ssrRenderComponent(_component_pagination, { paginating: _ctx.withdrawals }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
            ...
            createVNode("div", { class: "flex mx-auto lg:mr-4" }, [
              createVNode("div", { class: "container mx-auto sm:px-6 lg:px-8" }, [
                createVNode("div", { class: "bg-white overflow-hidden shadow-xl sm:rounded-lg" }, [
                  createVNode("div", { class: "bg-white/40 overflow-hidden drop-shadow-md shadow-xl hover:drop-shadow-lg hover:shadow-2xl sm:rounded-lg m-4 w-72 h-28 mx-auto flex justify-between items-center" }, [
                    createVNode("div", { class: "flex flex-col items-center text-center p-3" }, [
                      ...
                      createVNode("span", { class: "text-xl text-blue-brand-gradient1 hover:text-2xl font-semibold" }, toDisplayString(_ctx.exchange[0].dollar_sell), 1)
                    ])
                  ]),
