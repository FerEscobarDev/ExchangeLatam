...
const _sfc_main = defineComponent({
  ...
  methods: {
    submit() {
      this.form.get(route("user.index"));
    },
    dateFormat(date) {
  ...
  _push(ssrRenderComponent(_component_app_layout_admin, mergeProps({ title: "Usuarios" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`</form><table class="min-w-full divide-y divide-gray-200"${_scopeId}><thead class="bg-gray-50"${_scopeId}><tr${_scopeId}><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Nombre </th><th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Documento </th><th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Celular </th><th scope="col" class="hidden md:table-cell px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Formularios </th><th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Estado </th><th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Email </th><th scope="col" class="hidden md:table-cell px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> Fecha Registro </th><th scope="col" class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"${_scopeId}> ID </th></tr></thead>`);
        if (_ctx.users.data[0]) {
          _push2(`<tbody class="bg-white divide-y divide-gray-200"${_scopeId}><!--[-->`);
          ssrRenderList(_ctx.users.data, (user) => {
            _push2(`<tr class="odd:bg-white even:bg-gray-50"${_scopeId}><td class="text-center font-semibold px-6 py-4 whitespace-nowrap text-sm"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Link, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (user.picture) {
                    _push3(`<span${_scopeId2}><img${ssrRenderAttr("src", _ctx.$page.props.ziggy.url + "/storage/" + user.picture)}${ssrRenderAttr("alt", user.name)} class="rounded-full h-10 w-10 object-cover"${_scopeId2}></span>`);
                  } else {
                    _push3(`<span${_scopeId2}><img${ssrRenderAttr("src", user.profile_photo_url)}${ssrRenderAttr("alt", user.name)} class="rounded-full h-10 w-10 object-cover"${_scopeId2}></span>`);
                  }
                  ...
                  return [
                    user.picture ? (openBlock(), createBlock("span", { key: 0 }, [
                      createVNode("img", {
            ...
            _push2(`</td><td class="text-left px-6 py-4 whitespace-nowrap text-sm font-medium"${_scopeId}>`);
            ...
            _push2(`</td><td class="text-center hidden md:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500"${_scopeId}>${ssrInterpolate(user.mobil)}</td><td class="text-center font-semibold px-6 py-4 whitespace-nowrap text-sm flex justify-start items-center"${_scopeId}>`);
            if (user.form_knowledge_client !== null) {
              _push2(`<span class="flex justify-center items-center"${_scopeId}>`);
              if (user.requirement_user.formKnowledge === 1) {
                _push2(ssrRenderComponent(_component_Link, {
            ...
            if (user.form_fund !== null) {
              _push2(`<span class="flex justify-center items-center"${_scopeId}>`);
              if (user.requirement_user.formFunds === 1) {
                _push2(ssrRenderComponent(_component_Link, {
            ...
            _push2(`</td><td class="text-center hidden md:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500"${_scopeId}>`);
            ...
            _push2(`</td><td class="text-center px-6 py-4 whitespace-nowrap text-sm text-gray-500"${_scopeId}>${ssrInterpolate(user.id)}</td></tr>`);
          });
          _push2(`<!--]--></tbody>`);
        } else {
        ...
        _push2(`</table>`);
        if (_ctx.users.data[0]) {
          _push2(ssrRenderComponent(_component_pagination, { paginating: _ctx.users }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
                  ...
                  createVNode("div", { class: "flex flex-col" }, [
                    createVNode("div", { class: "-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8" }, [
                      createVNode("div", { class: "py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8" }, [
                        createVNode("div", { class: "shadow overflow-hidden border-b border-gray-200 sm:rounded-lg bg-white" }, [
                          createVNode("form", {
                            onSubmit: withModifiers(_ctx.submit, ["prevent"]),
                            class: "flex justify-end items-center mb-5 mt-5 mr-5"
                          }, [
                            ...
                            _ctx.users.data[0] ? (openBlock(), createBlock("tbody", {
                              ...
                              (openBlock(true), createBlock(Fragment, null, renderList(_ctx.users.data, (user) => {
                                return openBlock(), createBlock("tr", {
                                  ...
                                  createVNode("td", { class: "text-center font-semibold px-6 py-4 whitespace-nowrap text-sm" }, [
                                    createVNode(_component_Link, {
                                      href: _ctx.route("admin.userShow", user.id),
                                      class: "text-indigo-600 hover:text-indigo-900 flex justify-start items-center"
                                    }, {
                                  ...
                                  createVNode("td", { class: "text-left px-6 py-4 whitespace-nowrap text-sm font-medium" }, [
                                  ...
                                  createVNode("td", { class: "text-center hidden md:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500" }, toDisplayString(user.mobil), 1),
                                  createVNode("td", { class: "text-center font-semibold px-6 py-4 whitespace-nowrap text-sm flex justify-start items-center" }, [
                                    user.form_knowledge_client !== null ? (openBlock(), createBlock("span", {
                                      key: 0,
                                      class: "flex justify-center items-center"
                                    }, [
                                      user.requirement_user.formKnowledge === 1 ? (openBlock(), createBlock(_component_Link, {
                                        key: 0,
                                        href: _ctx.route("formKnowledgeClient.showAdmin", user.form_knowledge_client.id),
                                        class: "flex justify-start items-center"
                                      }, {
                                    ...
                                    user.form_fund !== null ? (openBlock(), createBlock("span", {
                                      ...
                                      user.requirement_user.formFunds === 1 ? (openBlock(), createBlock(_component_Link, {
                                        key: 0,
                                        href: _ctx.route("formFund.showAdmin", user.form_fund.id),
                                        class: "flex justify-end items-center"
                                      }, {
                                  ...
                                  createVNode("td", { class: "text-center hidden md:table-cell px-6 py-4 whitespace-nowrap text-sm text-gray-500" }, [
                                  ...
                                  createVNode("td", { class: "text-center px-6 py-4 whitespace-nowrap text-sm text-gray-500" }, toDisplayString(user.id), 1)
                                ]);
                              }), 128))
