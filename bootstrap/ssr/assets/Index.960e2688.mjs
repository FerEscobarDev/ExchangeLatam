...
import TableWithdrawals from "./TableWithdrawals.d99b2815.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_app_layout_admin, mergeProps({ title: "Retiros" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="py-6 w-full"${_scopeId}><div class="flex mx-auto lg:mr-4"${_scopeId}><div class="container mx-auto sm:px-6 lg:px-8"${_scopeId}><div class="bg-white overflow-hidden sm:rounded-lg p-2"${_scopeId}><div class="w-full flex justify-end items-center p-4"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_Link, {
          href: _ctx.route("admin.createWithdrawal"),
        ...
        _push2(`</div><div class="flex flex-col px-4"${_scopeId}>`);
          ...
          createVNode("div", { class: "py-6 w-full" }, [
            createVNode("div", { class: "flex mx-auto lg:mr-4" }, [
              createVNode("div", { class: "container mx-auto sm:px-6 lg:px-8" }, [
                createVNode("div", { class: "bg-white overflow-hidden sm:rounded-lg p-2" }, [
                  createVNode("div", { class: "w-full flex justify-end items-center p-4" }, [
                    createVNode(_component_Link, {
                      href: _ctx.route("admin.createWithdrawal"),
                      class: "inline-flex justify-center items-center px-4 py-2 bg-dark-brand border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition"
                    }, {
