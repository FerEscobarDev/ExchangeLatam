import { defineComponent, useSSRContext, ref, onMounted, onUnmounted, mergeProps, resolveComponent, withCtx, renderSlot, computed, unref } from "vue";
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (_ctx.show && _ctx.message) {
    _push(`<div class="${ssrRenderClass({ "bg-blue-brand-gradient1": _ctx.style == "success", "bg-red-700": _ctx.style == "danger" })}"><div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8"><div class="flex items-center justify-between flex-wrap"><div class="w-0 flex-1 flex items-center min-w-0"><span class="${ssrRenderClass([{ "bg-blue-brand-complement": _ctx.style == "success", "bg-red-600": _ctx.style == "danger" }, "flex p-2 rounded-lg"])}">`);
