  ...
  data() {
    return {
      form: this.$inertia.form({
        _method: "PUT",
        date: this.dollarPrice.date,
        dollar_buy: this.dollarPrice.dollar_buy,
        dollar_sell: this.dollarPrice.dollar_sell
      })
    };
  },
  methods: {
    priceStore() {
      this.form.post(route("admin.dollarPriceUpdate", this.dollarPrice.id), {
        preserveScroll: true
      });
    }
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/DollarPrice/Partials/PriceEditForm.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const PriceEditForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  PriceEditForm as default
};
