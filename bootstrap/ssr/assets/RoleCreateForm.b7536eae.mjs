...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_jet_form, mergeProps({ onSubmitted: _ctx.roleCreate }, _attrs), {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Roles/Partials/RoleCreateForm.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RoleCreateForm = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  RoleCreateForm as default
};
