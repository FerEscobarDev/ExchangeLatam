...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[-->`);
  _push(ssrRenderComponent(_component_Head, { title: "SAGRILAFT Policy" }, null, _parent));
  ...
  _push(`</div><div class="w-full sm:max-w-4xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">${_ctx.policy}</div></div></div></div><!--]-->`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/SagrilaftPolicy.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SagrilaftPolicy = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  SagrilaftPolicy as default
};
