...
import { _ as _sfc_main$7 } from "./InputError.bc94ef1e.mjs";
...
const _sfc_main = defineComponent({
  ...
  methods: {
    ...
    submit() {
      ...
      this.form.post(this.route("admin.voucherUpWithdrawal", this.withdrawal.id), {
        onSuccess: () => this.clearFileInput()
      });
    },
    submitDelete() {
      this.formDelete.post(this.route("admin.destroyWithdrawal", this.withdrawal.id));
    },
    submitStatus() {
      this.formStatus.post(this.route("admin.statusWithdrawal", this.withdrawal.id), {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_app_layout_admin, mergeProps({ title: "Detalle del retiro" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        if (_ctx.withdrawal.account.number === "000000000") {
          ...
          _push2(`<div class="rounded-lg bg-slate-200 text-dark-brand p-4 w-80 flex flex-col items-start"${_scopeId}><span class="font-semibold"${_scopeId}>${ssrInterpolate(_ctx.withdrawal.user.name + " " + _ctx.withdrawal.user.lastname)}</span><span class="flex"${_scopeId}>`);
          if (_ctx.withdrawal.user.data_user.doc_type === 1) {
            _push2(`<span class="text-sm text-gray-600 mr-1"${_scopeId}>C\xE9dula: </span>`);
          } else if (_ctx.withdrawal.user.data_user.doc_type === 2) {
              ...
              createVNode("div", { class: "container mx-auto sm:px-6 lg:px-8" }, [
                createVNode("div", { class: "bg-white shadow-xl sm:rounded-lg flex flex-col" }, [
                  createVNode("div", { class: "grid grid-cols-6 p-4 mx-auto w-full xl:w-4/5 mt-5 h-min" }, [
                    createVNode("div", {
                      class: [{ "md:col-span-6": !_ctx.withdrawal.comment }, "col-span-6 md:col-span-3 flex flex-col justify-between items-center"]
                    }, [
                      ...
                      createVNode("div", { class: "rounded-lg text-dark-brand w-80 flex flex-col items-start" }, [
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          ...
                          createVNode("span", { class: "text-md font-semibold text-dark-brand" }, toDisplayString(_ctx.withdrawal.user.name + " " + _ctx.withdrawal.user.lastname), 1)
                        ]),
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                        ...
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          ...
                          createVNode("span", { class: "text-sm font-semibold text-dark-brand" }, toDisplayString(_ctx.withdrawal.transactionable.number), 1)
                        ]),
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                  ...
                  createVNode("div", { class: "grid grid-cols-6 p-4 mx-auto w-full xl:w-4/5 h-min" }, [
                    createVNode("div", { class: "col-span-6 md:col-span-3 flex flex-col justify-between items-center" }, [
                      ...
                      _ctx.withdrawal.account.number === "000000000" ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("span", { class: "font-semibold" }, toDisplayString(_ctx.withdrawal.user.name + " " + _ctx.withdrawal.user.lastname), 1),
                        createVNode("span", { class: "flex" }, [
                          _ctx.withdrawal.user.data_user.doc_type === 1 ? (openBlock(), createBlock("span", {
                            key: 0,
                            class: "text-sm text-gray-600 mr-1"
                          }, "C\xE9dula: ")) : _ctx.withdrawal.user.data_user.doc_type === 2 ? (openBlock(), createBlock("span", {
                            key: 1,
                            class: "text-sm text-gray-600 mr-1"
                          ...
                          createVNode("span", { class: "text-sm font-semibold text-dark-brand" }, toDisplayString(_ctx.withdrawal.user.data_user.doc_num), 1)
                        ]),
                        createVNode("span", { class: "flex" }, [
                    ...
                    createVNode("div", { class: "col-span-6 md:col-span-3 flex flex-col justify-between items-center mt-5 md:mt-0" }, [
                      ...
                      createVNode("div", { class: "rounded-lg text-dark-brand w-80 flex flex-col items-center" }, [
                        ...
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          ...
                          createVNode("span", { class: "font-semibold text-dark-brand" }, "$ " + toDisplayString(_ctx.withdrawal.rebate.toLocaleString()), 1)
                        ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Withdrawals/Show.vue");
