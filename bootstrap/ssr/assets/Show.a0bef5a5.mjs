...
import { _ as _sfc_main$5 } from "./ConfirmationModal.956871cf.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_app_layout_admin, mergeProps({ title: "Detalle del dep\xF3sito" }, _attrs), {
              ...
              createVNode("div", { class: "container mx-auto sm:px-6 lg:px-8" }, [
                createVNode("div", { class: "bg-white shadow-xl sm:rounded-lg flex flex-col" }, [
                  createVNode("div", { class: "grid grid-cols-6 p-4 mx-auto w-full xl:w-4/5 mt-5 h-min" }, [
                    createVNode("div", {
                      class: [{ "md:col-span-6": !_ctx.deposit.comment }, "col-span-6 md:col-span-3 flex flex-col justify-between items-center"]
                    }, [
                      ...
                      createVNode("div", { class: "rounded-lg text-dark-brand w-80 flex flex-col items-start" }, [
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          ...
                          createVNode("span", { class: "text-md font-semibold text-dark-brand" }, toDisplayString(_ctx.deposit.user.name + " " + _ctx.deposit.user.lastname), 1)
                        ]),
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Deposits/Show.vue");
