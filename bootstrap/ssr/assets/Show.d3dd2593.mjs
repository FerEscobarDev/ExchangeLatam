...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_app_layout, mergeProps({ title: "Detalle del dep\xF3sito" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="py-6 w-full"${_scopeId}><div class="flex mx-auto lg:mr-4"${_scopeId}><div class="container mx-auto sm:px-6 lg:px-8"${_scopeId}><div class="bg-white shadow-xl sm:rounded-lg flex flex-col"${_scopeId}><div class="grid grid-cols-6 p-4 mx-auto w-full xl:w-4/5 mt-5 h-min"${_scopeId}><div class="col-span-6 md:col-span-3 flex flex-col justify-between items-center"${_scopeId}><h2 class="text-lg text-dark-brand font-semibold mb-2"${_scopeId}> Detalles de la transacci\xF3n </h2><div class="rounded-lg text-dark-brand w-80 flex flex-col items-start"${_scopeId}><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-2"${_scopeId}>Broker: </span><span class="${ssrRenderClass([{ "text-green-500": _ctx.deposit.transactionable.broker.id === 1, "text-blue-800": _ctx.deposit.transactionable.broker.id === 2 }, "text-sm font-semibold"])}"${_scopeId}>${ssrInterpolate(_ctx.deposit.transactionable.broker.name)}</span></span><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-2"${_scopeId}>Cuenta de trading: </span><span class="text-sm font-semibold text-dark-brand"${_scopeId}>${ssrInterpolate(_ctx.deposit.transactionable.number)}</span></span><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-2"${_scopeId}>Fecha de solicitud: </span><span class="text-sm font-semibold text-dark-brand"${_scopeId}>${ssrInterpolate(_ctx.dateFormat(_ctx.deposit.application_date))}</span></span>`);
        if (_ctx.deposit.completed_date) {
          _push2(`<span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-2"${_scopeId}>Fecha de finalizaci\xF3n: </span><span class="text-sm font-semibold text-dark-brand"${_scopeId}>${ssrInterpolate(_ctx.dateFormat(_ctx.deposit.completed_date))}</span></span>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</div></div><div class="col-span-6 md:col-span-3 flex flex-col justify-between items-center mt-5 md:mt-0"${_scopeId}>`);
        if (_ctx.deposit.comment) {
          _push2(`<h2 class="text-lg text-dark-brand font-semibold mb-2"${_scopeId}>Comentarios</h2>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`<div class="rounded-lg text-dark-brand w-80 flex flex-col items-start"${_scopeId}><span class="flex items-center w-full"${_scopeId}><span class="text-sm text-gray-600 font-semibold"${_scopeId}>${ssrInterpolate(_ctx.deposit.comment)}</span></span></div></div></div><hr scope class="mx-auto w-4/5 border-0 h-[0.5px] bg-gradient-to-r from-slate-300 via-blue-brand to-slate-300 my-2"${_scopeId}><div class="grid grid-cols-6 p-4 mx-auto w-full xl:w-4/5 h-min"${_scopeId}><div class="col-span-6 md:col-span-3 flex flex-col justify-between items-center"${_scopeId}><h2 class="text-lg text-dark-brand font-semibold mb-2"${_scopeId}>Detalles de pago</h2><div class="rounded-lg text-dark-brand w-80 flex flex-col items-center pb-3"${_scopeId}><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>Debes realizar el pago a la siguiente cuenta bancaria por medio de transferencia o consignaci\xF3n:</span></span></div>`);
        if (_ctx.deposit.account.number === "000000000") {
          _push2(`<div class="rounded-lg bg-slate-200 text-dark-brand p-4 w-80 flex flex-col items-start"${_scopeId}><span class="text-sm text-gray-600 font-semibold mb-2"${_scopeId}>Los detalles la cuenta bancaria de este pago no est\xE1n disponibles, por favor revisa el comprobante.</span>`);
          if (_ctx.deposit.status === "Realizado") {
          ...
          } else if (_ctx.deposit.status === "Pendiente") {
          ...
          } else if (_ctx.deposit.status === "Cancelado") {
          ...
          _push2(`<span class="flex"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>Banco: </span><span class="text-sm font-semibold text-dark-brand"${_scopeId}>${ssrInterpolate(_ctx.deposit.account.bank.name)}</span></span><span class="flex"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>Cuenta: </span><span class="text-sm font-semibold text-dark-brand"${_scopeId}>${ssrInterpolate(_ctx.deposit.account.number)}</span></span><span class="flex mb-2"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>Tipo de Cuenta: </span><span class="text-sm font-semibold text-dark-brand"${_scopeId}>${ssrInterpolate(_ctx.deposit.account.type)}</span></span>`);
          if (_ctx.deposit.status === "Realizado") {
            _push2(`<span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 mx-auto"${_scopeId}> Pago Realizado </span>`);
          } else if (_ctx.deposit.status === "Pendiente") {
            _push2(`<span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-orange-100 text-orange-800 mx-auto"${_scopeId}> Procesando ... </span>`);
        ...
        _push2(`</div><div class="col-span-6 md:col-span-3 flex flex-col justify-between items-center mt-5 md:mt-0"${_scopeId}><h2 class="text-lg text-dark-brand font-semibold mb-2"${_scopeId}>Resumen de la transacci\xF3n</h2><div class="rounded-lg text-dark-brand w-80 flex flex-col items-center"${_scopeId}><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>Monto USD: </span><span class="font-semibold text-dark-brand"${_scopeId}>$ ${ssrInterpolate(_ctx.deposit.amount_usd.toLocaleString())}</span></span><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>Monto COP: </span><span class="font-semibold text-dark-brand"${_scopeId}>$ ${ssrInterpolate(_ctx.deposit.amount_cop.toLocaleString())}</span></span><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>Impuesto 4x1000: </span><span class="font-semibold text-dark-brand"${_scopeId}>$ ${ssrInterpolate(_ctx.deposit.cuatro_por_mil.toLocaleString())}</span></span><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>Comisi\xF3n: </span><span class="font-semibold text-dark-brand"${_scopeId}>$ ${ssrInterpolate(_ctx.deposit.comission.toLocaleString())}</span></span><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>Impuesto IVA: </span><span class="font-semibold text-dark-brand"${_scopeId}>$ ${ssrInterpolate(_ctx.deposit.iva.toLocaleString())}</span></span><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-sm text-gray-600 mr-1"${_scopeId}>Descuento VIP: </span><span class="font-semibold text-dark-brand"${_scopeId}>$ ${ssrInterpolate(_ctx.deposit.rebate.toLocaleString())}</span></span><div class="mx-auto w-4/5 border-0 h-[1px] bg-gradient-to-r from-slate-300 via-blue-brand to-slate-300 my-5"${_scopeId}></div><span class="flex justify-between items-center w-full"${_scopeId}><span class="text-base text-dark-brand mr-1"${_scopeId}>Total a pagar COP: </span><span class="font-semibold text-dark-brand"${_scopeId}>$ ${ssrInterpolate(_ctx.deposit.total.toLocaleString())}</span></span></div></div></div><div class="mx-auto w-4/5 border-0 h-[1px] bg-gradient-to-r from-slate-300 via-blue-brand to-slate-300 my-2"${_scopeId}></div><div class="grid grid-cols-6 p-4 mx-auto w-full xl:w-4/5 h-min"${_scopeId}>`);
                ...
                createVNode("div", { class: "bg-white shadow-xl sm:rounded-lg flex flex-col" }, [
                    ...
                    createVNode("div", { class: "col-span-6 md:col-span-3 flex flex-col justify-between items-center" }, [
                      ...
                      createVNode("div", { class: "rounded-lg text-dark-brand w-80 flex flex-col items-start" }, [
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          ...
                          createVNode("span", {
                            class: [{ "text-green-500": _ctx.deposit.transactionable.broker.id === 1, "text-blue-800": _ctx.deposit.transactionable.broker.id === 2 }, "text-sm font-semibold"]
                          }, toDisplayString(_ctx.deposit.transactionable.broker.name), 3)
                        ]),
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          createVNode("span", { class: "text-sm text-gray-600 mr-2" }, "Cuenta de trading: "),
                          createVNode("span", { class: "text-sm font-semibold text-dark-brand" }, toDisplayString(_ctx.deposit.transactionable.number), 1)
                        ]),
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          createVNode("span", { class: "text-sm text-gray-600 mr-2" }, "Fecha de solicitud: "),
                          createVNode("span", { class: "text-sm font-semibold text-dark-brand" }, toDisplayString(_ctx.dateFormat(_ctx.deposit.application_date)), 1)
                        ]),
                        _ctx.deposit.completed_date ? (openBlock(), createBlock("span", {
                          key: 0,
                          class: "flex justify-between items-center w-full"
                        }, [
                          createVNode("span", { class: "text-sm text-gray-600 mr-2" }, "Fecha de finalizaci\xF3n: "),
                          createVNode("span", { class: "text-sm font-semibold text-dark-brand" }, toDisplayString(_ctx.dateFormat(_ctx.deposit.completed_date)), 1)
                        ])) : createCommentVNode("", true)
                      ])
                    ]),
                    createVNode("div", { class: "col-span-6 md:col-span-3 flex flex-col justify-between items-center mt-5 md:mt-0" }, [
                      _ctx.deposit.comment ? (openBlock(), createBlock("h2", {
                        key: 0,
                      ...
                      createVNode("div", { class: "rounded-lg text-dark-brand w-80 flex flex-col items-start" }, [
                        createVNode("span", { class: "flex items-center w-full" }, [
                          createVNode("span", { class: "text-sm text-gray-600 font-semibold" }, toDisplayString(_ctx.deposit.comment), 1)
                        ])
                      ])
                    ])
                  ]),
                  ...
                  createVNode("div", { class: "grid grid-cols-6 p-4 mx-auto w-full xl:w-4/5 h-min" }, [
                    createVNode("div", { class: "col-span-6 md:col-span-3 flex flex-col justify-between items-center" }, [
                      ...
                      _ctx.deposit.account.number === "000000000" ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "rounded-lg bg-slate-200 text-dark-brand p-4 w-80 flex flex-col items-start"
                      }, [
                        createVNode("span", { class: "text-sm text-gray-600 font-semibold mb-2" }, "Los detalles la cuenta bancaria de este pago no est\xE1n disponibles, por favor revisa el comprobante."),
                        _ctx.deposit.status === "Realizado" ? (openBlock(), createBlock("span", {
                          key: 0,
                          class: "px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 mx-auto"
                        }, " Pago Realizado ")) : _ctx.deposit.status === "Pendiente" ? (openBlock(), createBlock("span", {
                          key: 1,
                          class: "px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-orange-100 text-orange-800 mx-auto"
                        }, " Procesando ... ")) : _ctx.deposit.status === "Cancelado" ? (openBlock(), createBlock("span", {
                          key: 2,
                          class: "px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-orange-100 text-orange-800 mx-auto"
                        ...
                        _ctx.deposit.account_id !== 3 ? (openBlock(), createBlock("span", {
                          key: 0,
                          class: "flex"
                        }, [
                        ...
                        createVNode("span", { class: "flex" }, [
                          ...
                          createVNode("span", { class: "text-sm font-semibold text-dark-brand" }, toDisplayString(_ctx.deposit.account.bank.name), 1)
                        ]),
                        createVNode("span", { class: "flex" }, [
                          createVNode("span", { class: "text-sm text-gray-600 mr-1" }, "Cuenta: "),
                          createVNode("span", { class: "text-sm font-semibold text-dark-brand" }, toDisplayString(_ctx.deposit.account.number), 1)
                        ]),
                        createVNode("span", { class: "flex mb-2" }, [
                          createVNode("span", { class: "text-sm text-gray-600 mr-1" }, "Tipo de Cuenta: "),
                          createVNode("span", { class: "text-sm font-semibold text-dark-brand" }, toDisplayString(_ctx.deposit.account.type), 1)
                        ]),
                        _ctx.deposit.status === "Realizado" ? (openBlock(), createBlock("span", {
                          key: 4,
                          class: "px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 mx-auto"
                    ...
                    createVNode("div", { class: "col-span-6 md:col-span-3 flex flex-col justify-between items-center mt-5 md:mt-0" }, [
                      ...
                      createVNode("div", { class: "rounded-lg text-dark-brand w-80 flex flex-col items-center" }, [
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          ...
                          createVNode("span", { class: "font-semibold text-dark-brand" }, "$ " + toDisplayString(_ctx.deposit.amount_usd.toLocaleString()), 1)
                        ]),
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          createVNode("span", { class: "text-sm text-gray-600 mr-1" }, "Monto COP: "),
                          createVNode("span", { class: "font-semibold text-dark-brand" }, "$ " + toDisplayString(_ctx.deposit.amount_cop.toLocaleString()), 1)
                        ]),
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          createVNode("span", { class: "text-sm text-gray-600 mr-1" }, "Impuesto 4x1000: "),
                          createVNode("span", { class: "font-semibold text-dark-brand" }, "$ " + toDisplayString(_ctx.deposit.cuatro_por_mil.toLocaleString()), 1)
                        ]),
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          createVNode("span", { class: "text-sm text-gray-600 mr-1" }, "Comisi\xF3n: "),
                          createVNode("span", { class: "font-semibold text-dark-brand" }, "$ " + toDisplayString(_ctx.deposit.comission.toLocaleString()), 1)
                        ]),
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          createVNode("span", { class: "text-sm text-gray-600 mr-1" }, "Impuesto IVA: "),
                          createVNode("span", { class: "font-semibold text-dark-brand" }, "$ " + toDisplayString(_ctx.deposit.iva.toLocaleString()), 1)
                        ]),
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          createVNode("span", { class: "text-sm text-gray-600 mr-1" }, "Descuento VIP: "),
                          createVNode("span", { class: "font-semibold text-dark-brand" }, "$ " + toDisplayString(_ctx.deposit.rebate.toLocaleString()), 1)
                        ]),
                        ...
                        createVNode("span", { class: "flex justify-between items-center w-full" }, [
                          ...
                          createVNode("span", { class: "font-semibold text-dark-brand" }, "$ " + toDisplayString(_ctx.deposit.total.toLocaleString()), 1)
                        ])
                      ])
                    ])
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Deposits/Show.vue");
