...
import UpdatePhoto from "./UpdatePhoto.0a5f5205.mjs";
import UpdateData from "./UpdateData.1a0fa009.mjs";
  ...
  _push(ssrRenderComponent(_component_app_layout, mergeProps({ title: "Perfil" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`</div><div class="bg-white shadow-xl sm:rounded-lg mt-5 overflow-visible"${_scopeId}>`);
