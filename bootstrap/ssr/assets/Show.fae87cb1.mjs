...
import UpdatePhoto from "./UpdatePhoto.9939e774.mjs";
import UpdateData from "./UpdateData.44d2cc7f.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_update_photo = resolveComponent("update-photo");
  ...
  _push(ssrRenderComponent(_component_app_layout, mergeProps({ title: "Perfil" }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_update_photo, {
          user: _ctx.$page.props.user
        }, null, _parent2, _scopeId));
        _push2(`</div><div class="mt-6 lg:mr-4 max-w-full flex flex-col shadow border border-gray-200 sm:rounded-lg bg-white"${_scopeId}>`);
        ...
        return [
          createVNode("div", { class: "px-3 lg:mr-4 max-w-full flex flex-col shadow border border-gray-200 sm:rounded-lg bg-white" }, [
            createVNode(_component_update_photo, {
              user: _ctx.$page.props.user
            }, null, 8, ["user"])
          ]),
          createVNode("div", { class: "mt-6 lg:mr-4 max-w-full flex flex-col shadow border border-gray-200 sm:rounded-lg bg-white" }, [
            createVNode(_component_update_data, {
              user: _ctx.$page.props.user,
              departaments: _ctx.departaments,
              cities: _ctx.cities
            }, null, 8, ["user", "departaments", "cities"])
          ])
        ];
      }
    }),
