<template>
    <div class="mb-4 mr-4">
        <div class="rounded-lg" :class="{ 'bg-blue-brand-gradient1': style == 'success', 'bg-red-700': style == 'danger' }" v-if="show && message">
            <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex p-2 rounded-lg" :class="{ 'bg-blue-brand-complement': style == 'success', 'bg-red-600': style == 'danger' }">
                    ...
                    <div class="flex-shrink-0 sm:ml-3">
                        <button
                            ...
                            :class="{ 'hover:bg-blue-brand-complement focus:bg-blue-brand-complement': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger' }"
                            aria-label="Dismiss"
