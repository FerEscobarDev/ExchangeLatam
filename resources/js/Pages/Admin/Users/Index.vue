                            ...
                            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg bg-white">
                                        <form @submit.prevent="submit" class="flex justify-end items-center mb-5 mt-5 mr-5">
                                            <jet-input id="search" type="text" placeholder="Buscar" autofocus v-model="form.search"/>
                                            <Button class="ml-2" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Buscar</Button>
                                        </form>
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tbody class="bg-white divide-y divide-gray-200" v-if="users.data[0]">
                                                <tr v-for="user in users.data" :key="user.id" class="odd:bg-white even:bg-gray-50">
                                                    ...
                                                    <td class="text-center font-semibold px-6 py-4 whitespace-nowrap text-sm flex justify-start items-center">
                                                        <span class="flex justify-center items-center" v-if="user.form_knowledge_client !== null">
                                                            <Link v-if="user.requirement_user.formKnowledge === 1" :href="route('formKnowledgeClient.showAdmin', user.form_knowledge_client.id)" class="flex justify-start items-center">
                                                        ...
                                                        <span class="flex justify-center items-center" v-if="user.form_fund !== null">                                                            
                                                            <Link v-if="user.requirement_user.formFunds === 1" :href="route('formFund.showAdmin', user.form_fund.id)" class="flex justify-end items-center">
                                        ...
                                        <pagination v-if="users.data[0]" :paginating="users"/>
                                    </div>
                                </div>
                            </div>
                        </div>
