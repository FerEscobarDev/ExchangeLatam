                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg py-6">   
                        ...
                        <div class="grid grid-cols-6 gap-2 px-4 py-5">
                            ...
                            <div class="col-span-3 md:col-end-7 md:col-span-2">
                                ...
                                <jet-input readonly id="citySign" type="text" class="read-only:bg-gray-200 mt-1 block w-full" v-model="formKnowledgeClient.citySign"/>
                            </div>                                
                            ...
                            <div class="col-span-6 md:col-span-2">
                                ...
                                <jet-input readonly id="expeditionDate" type="date" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.data_user.expeditionDate"/>
                            </div>

                            <!-- Lugar de expedición -->
                            <div class="col-span-6 md:col-span-2">
                                <jet-label for="expeditionPlace" value="Lugar de expedición" />
                                <jet-input readonly id="expeditionPlace" type="text" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.data_user.expeditionPlace"/>
                            </div>

                            <!-- Fecha nacimiento -->
                            <div class="col-span-6 md:col-span-2">
                                <jet-label for="birthDate" value="Fecha de nacimiento" />
                                <jet-input readonly id="birthDate" type="date" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.data_user.birthDate"/>
                            </div>

                            <!-- Lugar de nacimiento -->
                            <div class="col-span-6 md:col-span-2">
                                <jet-label for="birthPlace" value="Lugar de nacimiento" />
                                <jet-input readonly id="birthPlace" type="text" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.data_user.birthPlace"/>
                            </div>

                            <!-- Nacionalidad 1 -->
                            <div class="col-span-6 md:col-span-2">
                                <jet-label for="nationality" value="Nacionalidad" />
                                <jet-input readonly id="nationality" type="text" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.data_user.nationality"/>
                            </div>
                            ...
                            <div class="col-span-6 md:col-span-2">
                                ...
                                <jet-input readonly id="income" type="number" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.financial_data_user.income"/>
                            </div>

                            <!-- Egresos Mensuales -->
                            <div class="col-span-6 md:col-span-2">
                                <jet-label for="expenses" value="Egresos Mensuales (COP)" />
                                <jet-input readonly id="expenses" type="number" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.financial_data_user.expenses"/>
                            </div>

                            <!-- Activos -->
                            <div class="col-span-6 md:col-span-2">
                                <jet-label for="assets" value="Activos (COP)" />
                                <jet-input readonly id="assets" type="number" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.financial_data_user.assets"/>
                            </div>

                            <!-- Pasivos -->
                            <div class="col-span-6 md:col-span-2">
                                <jet-label for="liabilities" value="Pasivos (COP)" />
                                <jet-input readonly id="liabilities" type="number" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.financial_data_user.liabilities"/>
                            </div>

                            <!-- Patrimonio -->
                            <div class="col-span-6 md:col-span-2">
                                <jet-label for="heritage" value="Patrimonio (COP)" />
                                <jet-input readonly id="heritage" type="number" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.financial_data_user.heritage"/>
                            </div>

                            <!-- Otros Ingresos -->
                            <div class="col-span-6 md:col-span-2">
                                <jet-label for="incomeOther" value="Otros Ingresos (COP)" />
                                <jet-input readonly id="incomeOther" type="number" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.financial_data_user.incomeOther"/>
                            </div>

                            <!-- Concepto otros Ingresos -->
                            <div v-if="$page.props.user.financial_data_user.incomeOther" class="col-span-6">
                                <jet-label for="descriptionIncome" value="Concepto Otros Ingresos" />
                                <jet-input readonly id="descriptionIncome" type="text" class="read-only:bg-gray-200 mt-1 block w-full" v-model="$page.props.user.financial_data_user.descriptionIncome" />
                            </div>
                            ...
                            <div class="col-span-6 text-md md:text-lg text-black/60 font-medium text-justify px-4"> 
                                <div class="flex items-center">
                                    <jet-checkbox readonly disabled name="sign" id="sign" class="ml-4" v-model:checked="sign" />  <span class="px-2 text-black/75">Firma electrónica:</span> <span class="underline">{{$page.props.user.name + ' ' + $page.props.user.lastname}}</span>
                                </div>
                            ...
                            <div class="col-span-6">                                
                                <div v-if="$page.props.flash.success" class=" max-w-max mx-auto mb-5">
                                    <Link disabled :href="route('verification.create')" class="text-center inline-flex items-center px-4 py-2 bg-dark-brand border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
                                        Finalizar
                                    </Link>
                                </div>
                            </div>
