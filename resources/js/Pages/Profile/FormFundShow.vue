                        ...
                        <div>
                            <div class="col-span-6">
                                <p class="text-lg md:text-xl text-black/60 font-medium text-justify px-4 md:px-8 max-w-3xl lg:mx-auto mb-4">
                                    Yo, <span class="text-black/50 font-semibold underline decoration-2">{{$page.props.user.name + ' ' + $page.props.user.lastname}}</span>, identificado(a) 
                                    con el documento de identidad No. <span class="text-black/50 font-semibold underline decoration-2">{{$page.props.user.data_user.doc_num}}</span> expedido en 
                                    <span class="text-black/50 font-semibold underline decoration-2">{{$page.props.user.data_user.expeditionPlace}}</span>, 
