    ...
    <jet-form @submitted="updateData">
        <template #form>
            ...
            <div class="col-span-6 md:col-span-3">
                ...
                <jet-input :readonly="verified"  id="name" type="text" class="mt-1 block w-full" v-model="form.name"/>
            ...
            <div class="col-span-6 md:col-span-3">
                ...
                <jet-input :readonly="verified" id="lastname" type="text" class="mt-1 block w-full" v-model="form.lastname"/>
                <jet-input-error :message="form.errors.lastname" class="mt-2" />
            </div>

            <div class="col-span-6 md:col-span-3">
                <jet-select  :disabled="verified" :selectable="type_doc" :selected="form.doc_type" v-model="form.doc_type">
                    <template #title>
                        Tipo de documento                           
                    </template>
                </jet-select>
            ...
            <div class="col-span-6 md:col-span-3">
                ...
                <jet-input :readonly="verified" id="doc_num" type="number" class="mt-1 block w-full" v-model="form.doc_num"/>
