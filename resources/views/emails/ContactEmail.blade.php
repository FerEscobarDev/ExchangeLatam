		...
		<div class="inner-body">
            <div class="content-cell">
                ...
                <div class="subcopy">
                    ...
                    <p><span class="break-all">Si tienes problemas haciendo click en el botón "Acceder", copia y pega el siguiente enlace en tú navegador: <a href="{{ 'https://admin.exchangelatam.com/admin/user/'.$email['user_id'].'/deposits' }}">{{ 'https://admin.exchangelatam.com/admin/user/'.$email['user_id'].'deposits' }}</a></span></p>
                </div>
            </div>
		</div>
    </div>
