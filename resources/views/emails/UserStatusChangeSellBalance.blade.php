		...
		<div class="inner-body">
            <div class="content-cell">
                ...
                @if ($notify->status == 'Realizado')
                    <p>
                        Hemos realizado el pago por la venta de tu saldo de la cuenta {{$notify->wallet_email}} de {{$notify->wallet}} de manera exitosa, si tu cuenta registrada es bancolombia tu dinero ya se ve reflejado en tu cuenta bancaria, si es de otro banco puede verse reflejado en unas horas o el siguiente día hábil.
                    </p>
                ...
                <p>Consulta los detalles de la transacción desde el siguiente botón.</p>

                <div class="action">
                    <a class="button button-primary" style="color: #fff;" href="{{'https://exchangelatam.com/dashboard/walletexchange/'.$notify->transaction_id.'/show'}}" target="_blank">Ver Detalles</a>
                </div>
                ...
                <div class="subcopy">
                    ...
                    <p><span class="break-all">Si tienes problemas haciendo click en el botón "Acceder", copia y pega el siguiente enlace en tú navegador: <a href="{{'https://exchangelatam.com/dashboard/walletexchange/'.$notify->transaction_id.'/show'}}">{{'https://exchangelatam.com/dashboard/walletexchange/'.$notify->transaction_id.'/show'}}</a></span></p>
                </div>
            </div>
		</div>
    </div>
